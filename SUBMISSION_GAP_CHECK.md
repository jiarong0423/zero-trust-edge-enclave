...
Local self-checks against the 111-file candidate built from `public-export-manifest.md`:

```text
export-gate:      pass, blocking 0, P0 0, P1 0, P2 0, critical 0, high 7
release-boundary: PASS, findings 0
localguard:       83 findings, 3 CRITICAL / 15 HIGH / 58 MEDIUM / 7 LOW
npm test:         99 of 99, thirty consecutive runs
