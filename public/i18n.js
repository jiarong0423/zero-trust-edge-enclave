...
export const labels = {
  ...
  'AI suggests approved routes only; it cannot read files or grant access.': 'AI：只根據允許的代碼建議路由；不能看文件、金鑰或憑據，也不能擴權。',
  ...
  'ADVISER_UNAVAILABLE': '路由建議服務無法使用', 'ADVICE_INVALID': '建議格式不合規',
  ...
  DRY_RUN_PREPARED: '模擬投遞完成（未寄信）', RETRY_WAIT: '等待有限重試', OUTCOME_UNKNOWN: '結果未知，停止自動重送',
  ...
  DELIVERY_TRANSITION: '投遞狀態變更', PACKAGE_CREATED: '密件已建立', TIMED_CREDENTIAL_ISSUED: '已發行短效憑證',
