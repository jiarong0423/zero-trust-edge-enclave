...
export const labels = {
  ...
  'Ciphertext hash': '密文指紋', 'One-way delivery link': '密件存取連結',
  ...
  DECODE_ATTEMPT: '解密驗證', PACKAGE_REVOKED: '密件已撤銷', EVIDENCE_VIEWED: '證據鏈已查看',
  EMAIL_DRY_RUN_PREPARED: '郵件演練已準備', RECIPIENT_ACKNOWLEDGED: '收件人已確認收件', CLIENT_FILE_VERIFIED: '收件端檔案已驗證',
  DELIVERY_OVERDUE: '投遞已逾期', DELIVERY_WINDOW_CLOSED: '投遞時限已結束', RESUME_VALIDATED: '恢復申請已驗證', UNKNOWN_EVENT: '未分類事件',
